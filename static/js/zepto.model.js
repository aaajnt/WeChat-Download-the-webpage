...
Touch=window.Touch||{};(function(exports){exports.getUrlParam=function(name){var reg=new RegExp("(^|&)"+name+"=([^&]*)(&|$)");var r=decodeURI(window.location.search).substr(1).match(reg);if(r!=null){return unescape(r[2]);}
return'';};exports.getUrlParamEncode=function(name){var reg=new RegExp("(^|&)"+name+"=([^&]*)(&|$)");var sStr=decodeURI(window.location.search).substr(1);sStr=sStr.replace(/&/g,"&amp;");sStr=sStr.replace(/>/g,"&gt;");sStr=sStr.replace(/</g,"&lt;");sStr=sStr.replace(/"/g,"&quot;");sStr=sStr.replace(/'/g,"&apos;");sStr=sStr.replace(/=/g,"&#61;");sStr=sStr.replace(/`/g,"&#96;");var r=sStr.match(reg);if(r!=null){return unescape(r[2]);}
return'';};exports.getUrlArgs=function(){var args={},query=location.search.substring(1),pairs=query.split("&");for(var i=0;i<pairs.length;i++){var pos=pairs[i].indexOf('=');if(pos==-1)continue;var argname=pairs[i].substring(0,pos),value=pairs[i].substring(pos+1);value=decodeURIComponent(value);args[argname]=value;}
return args;};exports.getAllArgs=function(){var sStr=decodeURI(window.location.search).substr(1);sStr=sStr.replace(/&/g,"&amp;");sStr=sStr.replace(/>/g,"&gt;");sStr=sStr.replace(/</g,"&lt;");sStr=sStr.replace(/"/g,"&quot;");sStr=sStr.replace(/'/g,"&apos;");sStr=sStr.replace(/=/g,"&#61;");sStr=sStr.replace(/`/g,"&#96;");return sStr;};})(Touch.Util={});Touch=window.Touch||{};(function(exports){exports.getUrlParam=function(name){var reg=new RegExp("(^|&)"+name+"=([^&]*)(&|$)");var r=decodeURI(window.location.search).substr(1).match(reg);if(r!=null){return unescape(r[2]);}
return'';};exports.getUrlParamEncode=function(name){var reg=new RegExp("(^|&)"+name+"=([^&]*)(&|$)");var sStr=decodeURI(window.location.search).substr(1);sStr=sStr.replace(/&/g,"&amp;");sStr=sStr.replace(/>/g,"&gt;");sStr=sStr.replace(/</g,"&lt;");sStr=sStr.replace(/"/g,"&quot;");sStr=sStr.replace(/'/g,"&apos;");sStr=sStr.replace(/=/g,"&#61;");sStr=sStr.replace(/`/g,"&#96;");var r=sStr.match(reg);if(r!=null){return unescape(r[2]);}
return'';};exports.getUrlArgs=function(){var args={},query=location.search.substring(1),pairs=query.split("&");for(var i=0;i<pairs.length;i++){var pos=pairs[i].indexOf('=');if(pos==-1)continue;var argname=pairs[i].substring(0,pos),value=pairs[i].substring(pos+1);value=decodeURIComponent(value);args[argname]=value;}
return args;};exports.getAllArgs=function(){var sStr=decodeURI(window.location.search).substr(1);sStr=sStr.replace(/&/g,"&amp;");sStr=sStr.replace(/>/g,"&gt;");sStr=sStr.replace(/</g,"&lt;");sStr=sStr.replace(/"/g,"&quot;");sStr=sStr.replace(/'/g,"&apos;");sStr=sStr.replace(/=/g,"&#61;");sStr=sStr.replace(/`/g,"&#96;");return sStr;};})(Touch.Util={});function global_check_wp()
{var navigator=window.navigator;userAgent=navigator.userAgent;wp=userAgent.match(/(Windows\s+Phone)\s([\d\.]+)/);return wp;}
function global_check_platform()
{var platfrom='0';if($.os)
...
{platfrom=48;}
return platfrom;}/*  |xGv00|848930f89f834e9a70893e8c25d906af */
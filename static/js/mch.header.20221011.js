...
MCH.header.setSwitchAccountUrl=function(){var merchantType=$getCookie('wechatLoginFrom')||'';var jumpUrl='';if(merchantType==='merchantDologin'){jumpUrl='/index.php/core/account/switchMchAccount'}else if(merchantType==='providerDologin'){jumpUrl='/index.php/core/account/switchAccount';}else{jumpUrl='/index.php/core/account/switchMchAccount'}
$('#gotop').find('.switch').attr('href',jumpUrl);}
MCH.header.init();
window['MCH.header']='22118:20221011:20221011162506';
window['MCH.header.time'] && window['MCH.header.time'].push(new Date());/*  |xGv00|c961b3f19c532d03cdf0fd3c83798fd5 */